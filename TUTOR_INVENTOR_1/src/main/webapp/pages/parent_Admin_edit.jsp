...
<td>
  ...
  <a href="edit_parent?id=${e.id}"><i class='fa fa-edit' style="color:blue"></i></a> |
          <a href="delete_parentfirst?id=${e.id}"><i class="fa fa-trash" style="color:blue"></i></a>
        </td>
</tr>
</c:forEach>
</table>
