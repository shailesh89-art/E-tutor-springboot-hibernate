...
<header> <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="tutor_request">Find Request</a>
        </li>
        <li class="nav-item">
  ...
  <c:if test="${tutor.id == sessionScope.tutor_id}">
   <a href="tutorprofile?id=${tutor.id}" ><i class="fa fa-user-circle-o" style="font-size:24px"></i></a>
</c:if>
